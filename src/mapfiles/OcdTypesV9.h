...
public:
    ...
    struct FileHeader : public OcdTypesGeneric::FileHeaderGeneric
    {
    ...
    struct BaseSymbol
    {
        ...
        u16 numOfColors;
        u16 colors[14];
        OcdTypesGeneric::PascalString<31> name;
        Icon icon;
    };
    ...
    struct LineTextSymbol
    {
        ...
        OcdTypesGeneric::PascalString<31> text;
    ...
    struct TextSymbol
    {
        ...
        OcdTypesGeneric::PascalString<31>        font_name;
        BasicTextAttributes   basic;
    ...
    struct RectSymbol
    {
        ...
        OcdTypesGeneric::PascalString<3> unnumbered_text;
        u16 RESERVED_MEMBER2;
        OcdTypesGeneric::PascalString<31> RESERVED_MEMBER3;
    ...
    struct ObjectIndex
    {
        OcdTypesGeneric::OcdCoord bottom_left_bound;
        OcdTypesGeneric::OcdCoord top_right_bound;
        u32 pos;
        u32 size;
        i32  symbol;
        u8  type;
